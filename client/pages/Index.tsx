...
export default function Index() {
  ...
  const generateAiResponse = async (originalText: string, targetLanguage: string): Promise<string> => {
    ...
    const responses: Record<string, Record<string, string[]>> = {
      ...
      'hi': {
        "Hello, how are you doing today?": [
          "नमस्ते! मैं आज बहुत अच्छा हूँ, पूछने के लिए धन्यवाद। आ���से मिलकर खुशी हुई। आपका दिन कैसा रहा?",
      ...
      'th': {
        "Hello, how are you doing today?": [
          ...
          "สวัสดีครับ! ที่นี่ทุกอย่างเป็นไปด้วยดีมากครับ ขอบคุณสำหรับคำทักทายที่น่ารักครับ วั���นี้เป็นอย่างไรบ้างครับ?"
        ]
      },
      'vi': {
        "Hello, how are you doing today?": [
